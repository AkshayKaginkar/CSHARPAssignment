...
namespace Assignment_MovieApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to the Movie House!");
        ...
        static void ViewMoviesData(List<Movie> movies)
        {
            ...
            foreach (var movie in movies)
            {
                ...
                Console.WriteLine($"Date of Launch: {movie.LaunchDate}");
        ...
        static void ModifyData(List<Movie> movies)
        {
            ...
            if (movieToModify != null)
            {
                ...
                {
                    movieToModify.LaunchDate = newDateOfLaunch.ToString("yyyy-MM-dd");
                }
                else
                {
        ...
        {
            new Movie("Movie1", "Action", "2001-05-30", 100000),
            new Movie("Movie2", "Comedy", "2002-06-01", 150000),
            new Movie("Movie3", "Drama", "2003-06-05", 175000),
             new Movie("Movie4", "Action", "2004-06-05", 100000),
            new Movie("Movie5", "Action", "2005-06-05", 100000),
            new Movie("Movie6", "Action", "2006-06-05", 100000),
            new Movie("Movie7", "Comedy", "2007-06-05", 150000),
            new Movie("Movie8", "Comedy", "2008-06-05", 150000),
            new Movie("Movie9", "Drama", "2009-06-05", 175000)
        };
        }
    }
}
